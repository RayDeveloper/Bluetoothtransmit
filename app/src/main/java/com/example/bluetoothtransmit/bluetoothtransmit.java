package com.example.bluetoothtransmit;
...
public class bluetoothtransmit extends AppCompatActivity {
    ...
    public void initialize_layout() {
        ...
        adapter_paired_devices = new ArrayAdapter(getApplicationContext(), R.layout.activity_main);
